      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative bg-surface">
        ...
        <div className="w-full max-w-[420px] relative z-10">
          <div className="text-center mb-10">
            ...
            <p className="text-text-muted text-base">Sign in to your dashboard</p>
          </div>
          ...
          {/* OAuth */}
          <button type="button" onClick={() => window.location.href = `${import.meta.env.VITE_API_URL?.replace('/api', '') || 'http://localhost:5000'}/api/auth/google`} className="w-full py-3.5 bg-background hover:bg-surface-elevated border border-border rounded-xl flex items-center justify-center gap-3 transition-colors text-sm font-medium text-text-primary active:scale-[0.98]">
            <GoogleIcon />
            Google
          </button>
